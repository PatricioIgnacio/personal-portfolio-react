  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/logo-footer.png" alt="LogoPatricioSantibanez" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://web.facebook.com/patricioignacio.santibanezgonzalez"
            ...
            <li>
              <a
                href="https://www.instagram.com/patricioignaciosg"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/patricio-ignacio-santib%C3%A1%C3%B1ez-gonzalez-69a084197/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">I 💖 FRONTEND</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
